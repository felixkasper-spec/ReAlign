export const testimonials = [
  ...
  },
  {
    ...
    name: "Conny Hjortsberg",
  },
  {
    quote:
      "Har precis ensam lastat på 1000 kg makadam med skyffel på släpvagn och har inte minsta känning i kroppen. Då har jag ändå slarvat med träningen …detta hade jag inte kunnat drömma om innan jag började med träningen.",
    name: "Andreas Westerhäll",
  },
  {
    quote:
