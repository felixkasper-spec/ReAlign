...
> = {
  ...
  "hofter-niva-1": { level: "Nybörjare", weeks: "Engångspass", freq: "7 övningar", purpose: "Höft & bäcken" },
  "hofter-niva-2": { level: "Nybörjare", weeks: "Engångspass", freq: "6 övningar", purpose: "Höft & bäcken" },
  "hofter-niva-3": { level: "Medel", weeks: "Engångspass", freq: "5 övningar", purpose: "Höft & bäcken" },
